...
Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"></a>. <a title="Log out of this account" href="<?php echo wp_logout_url(get_permalink()); ?>">Log out</a>
...
<input name="url" id="url" value="" size="22" tabindex="3" />
